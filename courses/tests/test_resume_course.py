...
def test_resume_not_started(api_client, user_alice, course_python, lesson_decorators, lesson_generators):
    # Ensure order
...
@pytest.mark.django_db
def test_resume_partially_completed(api_client, user_alice, course_python, lesson_decorators, lesson_generators):
    lesson_decorators.order = 1
    lesson_decorators.save()
    lesson_generators.order = 2
    lesson_generators.save()
...
@pytest.mark.django_db
def test_resume_all_completed(api_client, user_alice, course_python, lesson_decorators, lesson_generators):
    lesson_decorators.order = 1
    lesson_decorators.save()
    lesson_generators.order = 2
    lesson_generators.save()
